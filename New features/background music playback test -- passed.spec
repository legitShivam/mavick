...
a = Analysis(['background music playback test -- passed.py'],
             pathex=['G:\\Shivam\\Coding\\Python\\Projects\\Jarvis\\New features'],
             binaries=[],
...
exe = EXE(pyz,
          ...
          name='background music playback test -- passed',
          debug=False,
